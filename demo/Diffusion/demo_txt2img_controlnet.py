...
from txt2img_controlnet_pipeline import Txt2ImgControlNetPipeline
...
image = load_image(
    "https://raw.githubusercontent.com/kamalkraj/AITemplate/controlnet/examples/05_stable_diffusion/bird%20(1).png"
)
...
if __name__ == "__main__":
    ...
    # Initialize demo
    demo = Txt2ImgControlNetPipeline(
    ...
    for _ in range(args.num_warmup_runs):
        images = demo.infer(prompt, negative_prompt, image_height, image_width, warmup=True, verbose=False, controlnet_image=canny_image)

    print("[I] Running StableDiffusion pipeline")
    if args.nvtx_profile:
        cudart.cudaProfilerStart()
    # import ipdb; ipdb.set_trace()
    images = demo.infer(prompt, negative_prompt, image_height, image_width, seed=args.seed, verbose=args.verbose, controlnet_image=canny_image)
    if args.nvtx_profile:
